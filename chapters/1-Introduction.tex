...
\begin{enumerate}
\item Portare i cinque iniettori di rumore di PuckTrick: \textbf{duplicati}, \textbf{etichette inconsistenti}, \textbf{valori mancanti}, \textbf{rumore} e \textbf{outlier}, dall'ecosistema Pandas a PySpark, preservando la semantica originale dei metodi;
