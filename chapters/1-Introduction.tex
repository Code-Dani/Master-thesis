...
\begin{itemize}
    ...
    \item Capitolo~\ref{chap:DesignAndImplementation}: illustra il design e l'implementazione della libreria estesa, la configurazione del cluster e le scelte progettuali adottate.
    \item Capitolo~\ref{chap:DatasetAnalysis}: presenta l'analisi del dataset effettuata in preparazione al setup sperimentale.
    \item Capitolo~\ref{chap:EmpyricAnalysis}: presenta il setup sperimentale, i dataset utilizzati e i risultati dell'analisi empirica.
    \item Capitolo~\ref{chap:conclusion}: conclude con una sintesi dei risultati, le limitazioni del lavoro e le direzioni di ricerca future.
\end{itemize}
